...
#TIME REGION
lastGPSTime: datetime = datetime(year=2003, month=1, day=23, hour=11, minute=0, second=0, tzinfo=timezone.utc) #Excel does not support timezones tzinfo=timezone.utc
